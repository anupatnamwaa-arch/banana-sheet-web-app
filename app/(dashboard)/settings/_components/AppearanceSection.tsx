...
const THEMES: { id: Theme; label: string; emoji: string }[] = [
  { id: "dark",   label: "กล้วยกลางคืน", emoji: "🌙" },
  { id: "light",  label: "กล้วยครีม",    emoji: "🍌" },
  { id: "system", label: "ตามระบบ",       emoji: "📱" },
];
...
export function AppearanceSection() {
  ...
  return (
    <SettingsSection title="หน้าตาแอป">
      {/* Theme picker */}
      <div className="px-4 py-3.5">
        <div className="mb-3 flex items-center gap-3">
          ...
          <p className="text-sm font-medium">ธีมแอป</p>
        </div>
      ...
      <div className="flex items-center gap-3 px-4 py-3.5">
        ...
        <div className="flex-1">
          <p className="text-sm font-medium">สีหลัก</p>
          <p className="mt-0.5 text-xs text-fg-muted">กล้วยเหลือง (Banana)</p>
        </div>
      ...
      <div className="flex items-center gap-3 px-4 py-3.5">
        ...
        <div className="flex-1">
          <p className="text-sm font-medium">โหมดซ่อนยอดเงิน</p>
          <p className="mt-0.5 text-xs text-fg-muted">ปิดบังตัวเลขทุกรายการ</p>
        </div>
